...
- (int32_t)doSomethingCool __attribute__((swift_name("doSomethingCool()")));
- (NSString *)greet __attribute__((swift_name("greet()")));
- (BOOL)someCrazyValidationLogicSomeCrazyString:(NSString *)someCrazyString __attribute__((swift_name("someCrazyValidationLogic(someCrazyString:)")));
@end
